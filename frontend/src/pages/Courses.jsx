    ...
    <div className="flex-1 bg-[#F8F9FB] p-8 font-poppins overflow-y-auto">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-[24px] p-8 shadow-sm border border-gray-100 h-fit">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button type="submit" className="w-full bg-[#FFB800] hover:bg-[#E6A600] text-[#1D1D47] py-4 rounded-xl font-bold flex items-center justify-center gap-2 transition-all mt-4">
          ...
          <div className="lg:col-span-2 bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6 border-b border-gray-50 flex justify-between items-center">
              ...
              <div className="relative">
                ...
                <input className="pl-9 pr-4 py-2 bg-gray-50 border-none rounded-lg text-xs w-48 outline-none focus:ring-1 focus:ring-indigo-100" placeholder="Search courses..." />
              </div>
            </div>
